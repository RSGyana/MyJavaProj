...
public class ShipmentTypeUtil {
	...
	public void generatePie(String path,List<Object[]> data) {
		...
		try {
		ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/shipmentA.jpg"), chart, 200, 200);
		} catch (IOException e) {
		e.printStackTrace();
		}
	}
		...
		try {
		ChartUtils.saveChartAsJPEG(new File(path+"/resources/images/shipmentB.jpg"), chart, 200, 200);
		} catch (IOException e) {
		e.printStackTrace();
		}
		}
