...
<body>
	...
	<div class="container">
		...
		<div class="card-body">
			...
			<div class="row">
					<div class="col-4">
						<label for="shippId"> SHIPPING ID: </label>
					</div>
					<div class="col-4">
						<form:input path="shippId" class="form-control" readonly="true" />
					</div>
					<div class="col-4">
						<!-- error message -->
					</div>
				...
				<div class="row">
					<div class="col-4">
						<label for="courierRefNum"> COURIERREFNUM: </label>
					</div>
					<div class="col-4">
			...
			<div class="row">
				...
				<div class="row">
					<div class="col-4">
					<label for="shipToAdrs"> SHIP TO ADRS: </label>
